...
SEARCH_EMBEDDING_MAX_CHARS = env_int("SEARCH_EMBEDDING_MAX_CHARS", 8000)
SEARCH_EMBEDDING_BATCH_SIZE = env_int("SEARCH_EMBEDDING_BATCH_SIZE", 32)
...
SEARCH_RERANKER_ENABLED = env_bool("SEARCH_RERANKER_ENABLED", False)
SEARCH_RERANKER_MODEL = os.getenv("SEARCH_RERANKER_MODEL", "noop")
SEARCH_RERANKER_TOP_K = env_int("SEARCH_RERANKER_TOP_K", 50)
MODEL_STACK_BENCHMARK_LOAD_MODELS = env_bool("MODEL_STACK_BENCHMARK_LOAD_MODELS", False)
SEARCH_INDEX_VERSION = env_int("SEARCH_INDEX_VERSION", 2)
SEARCH_CHUNKING_VERSION = os.getenv("SEARCH_CHUNKING_VERSION", "chunking-v1")
SEARCH_NORMALIZATION_VERSION = os.getenv("SEARCH_NORMALIZATION_VERSION", "normalization-v1")
...
HEALTH_CHECK_STORAGE = env_bool("HEALTH_CHECK_STORAGE", True)
HEALTH_CHECK_QUEUE = env_bool("HEALTH_CHECK_QUEUE", True)
HEALTH_CHECK_PROCESSING_WORKER = env_bool("HEALTH_CHECK_PROCESSING_WORKER", True)
DMS_PROCESSING_STUCK_JOB_MINUTES = env_int("DMS_PROCESSING_STUCK_JOB_MINUTES", 30)
DMS_OBSERVABILITY_FAILED_JOBS_THRESHOLD = env_int("DMS_OBSERVABILITY_FAILED_JOBS_THRESHOLD", 5)
DMS_OBSERVABILITY_QUEUE_PENDING_THRESHOLD = env_int("DMS_OBSERVABILITY_QUEUE_PENDING_THRESHOLD", 50)
DMS_OBSERVABILITY_SEARCH_LATENCY_MS_THRESHOLD = env_int("DMS_OBSERVABILITY_SEARCH_LATENCY_MS_THRESHOLD", 2000)
DMS_OBSERVABILITY_STALE_DOCUMENTS_THRESHOLD = env_int("DMS_OBSERVABILITY_STALE_DOCUMENTS_THRESHOLD", 10)
DMS_GPU_AVAILABLE = env_bool("DMS_GPU_AVAILABLE", False)
